...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_ViewManagement_IUIViewSettingsPreferredInteractionMode<D>::GetPreferredInteractionMode(array_view<winrt::Windows::UI::ViewManagement::UserInteractionMode const> supportedModes) const
    {
        ...
        consume_general<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode>::GetPreferredInteractionMode, supportedModes.size(), get_abi(supportedModes), reinterpret_cast<std::int32_t*>(&result));
        return result;
    }
    ...
    {
        winrt::event_token token{};
        consume_general<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode>::add_PreferredInteractionModeChanged, *(void**)(&handler), put_abi(token));
        return token;
    }
    ...
    {
        consume_noexcept_remove_overload<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode>::remove_PreferredInteractionModeChanged, impl::bind_in(token));
    }
    ...
    {
        std::int32_t __stdcall GetPreferredInteractionMode(std::uint32_t __supportedModesSize, std::int32_t* supportedModes, std::int32_t* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall add_PreferredInteractionModeChanged(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall remove_PreferredInteractionModeChanged(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
