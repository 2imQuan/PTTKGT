...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"AlgorithmBenchmarkTool.MainWindow"))
    {
        return winrt_make_AlgorithmBenchmarkTool_MainWindow();
    }

    if (requal(name, L"AlgorithmBenchmarkTool.XamlMetaDataProvider"))
    {
        return winrt_make_AlgorithmBenchmarkTool_XamlMetaDataProvider();
    }
