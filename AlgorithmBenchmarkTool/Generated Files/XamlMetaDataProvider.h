...
/*
    ...
    namespace AlgorithmBenchmarkTool
    {
...
namespace winrt::AlgorithmBenchmarkTool::implementation
{
    ...
    struct XamlMetaDataProvider : public ::winrt::AlgorithmBenchmarkTool::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
